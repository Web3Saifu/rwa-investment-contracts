...
/**
 * @title InvestmentFunctions
 * @dev Function definitions for Investment
 * @custom:version 0.1.0
 */
interface IInvestmentFunctions {
    ...
    function simulateIndividualPeriodYield(uint256 productId, uint256 tokenId) external view returns (uint256[] memory);
